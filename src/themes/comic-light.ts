...
const css = `/* COMIC LIGHT BENTO THEME FOR ANKI & PREVIEW */
.card {
...
export const comicLightTheme: ThemeDefinition = {
  id: 'comic-light',
  name: 'Light Comic',
  description: 'Bright comic paper with clean high-contrast ink borders and crisp color highlights.',
  frontHtml,
  backHtml,
  css,
};
