...
const css = `/* THEME 3: GRAPHIC NOVEL / MANGA LIGHT */
.card {
...
.label-meaning { color: #047857; }
.label-example { color: #1D4ED8; }
...
export const comicMangaLightTheme: ThemeDefinition = {
  id: 'comic-manga-light',
  name: 'Graphic Novel Light',
  description: 'High-contrast ink framing inspired by modern graphic novels and comic ink art.',
